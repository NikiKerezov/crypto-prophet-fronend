...
function SignUp() {
  ...
  const [signUpSuccess, setSignUpSuccess] = useState(false); // New state for signup status
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${require("assets/img/sign_up_bg.png")})`,
            ...
            <Form className="form" onSubmit={requestSignUp}>
              ...
              <CardBody>
                {signUpSuccess ? ( // Display success message if signup is successful
                  ...
                  <>
                    {/* Your existing signup form components */}
                    <InputGroup
                      className={
